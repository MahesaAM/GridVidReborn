...
const Settings = ({ onBack }) => {
  ...
  const [excelFile, setExcelFile] = reactExports.useState("");
  reactExports.useEffect(() => {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-white/80 mb-4", children: "Import Accounts from Excel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white/70 mb-2", children: "Excel File" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-lg font-semibold text-white/80 mb-4", children: [
                "Accounts List (",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-auto", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-sm font-medium text-white/70", children: "Account List" }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-full divide-y divide-white/20", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider", children: "Email" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider", children: "Password" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider", children: "Status" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-white/70 uppercase tracking-wider", children: "Action" })
                  ] }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-white/10", children: accounts.length > 0 ? accounts.map((account) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    motion.tr,
                    {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-white", children: account.email }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-white/70", children: "Stored" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-green-400", children: "Active" })
                      ]
                    },
                    account.id
                    ...
                    "td",
                    {
                      ...
                      children: "No accounts imported yet. Import from Excel file above."
                    }
                  ) }) })
                ] })
              ] }),
              accounts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: handleSaveAccounts,
                  className: "mt-6 px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg font-semibold transition-colors duration-200",
                  children: "Save Accounts"
                }
              )
            ]
          }
...
function App() {
  ...
  const [preloadPath, setPreloadPath] = reactExports.useState("");
  const [prompts, setPrompts] = reactExports.useState("");
  const [savePath, setSavePath] = reactExports.useState("");
  const [aspectRatio2, setAspectRatio] = reactExports.useState("16:9");
  const [duration, setDuration] = reactExports.useState("5");
  const [isGenerating, setIsGenerating] = reactExports.useState(false);
  const [logs, setLogs] = reactExports.useState([]);
  const [stats, setStats] = reactExports.useState({ total: 0, success: 0, failed: 0 });
  const [isPopupDetected, setIsPopupDetected] = reactExports.useState(false);
  const promptsTextareaRef = reactExports.useRef(null);
  const savePathInputRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
  ...
  const handleGenerate = async () => {
    ...
    const promptList = mode === "text-to-video" ? prompts.split("\n").filter((p2) => p2.trim()) : [prompts];
    ...
    try {
      ...
      let promptIndex = 0;
      let accountIndex = 0;
      const exhaustedAccounts = /* @__PURE__ */ new Set();
      const loginWithAccount = async (account) => {
        const password = await window.electron.getAccountPassword(account.id);
        const signinUrl = "https://accounts.google.com/v3/signin/identifier?authuser=0&continue=https%3A%2F%2Fmyaccount.google.com%2Fgeneral-light&ec=GAlAwAE&hl=in&service=accountsettings&flowName=GlifWebSignIn&flowEntry=AddSession";
        ...
        if (webviewRef.current) {
          ...
          await loginPromise;
          const currentUrl2 = await webviewRef.current.executeJavaScript(
            `window.location.href`
          );
          if (currentUrl2.includes("/signin/challenge") || await webviewRef.current.executeJavaScript(
          ...
          if (currentUrl2.includes("/speedbump/")) {
      ...
      const generateVideo = async (prompt) => {
        ...
        try {
          ...
          if (!currentUrl2.includes("new_video")) {
            setCurrentUrl(
              "https://aistudio.google.com/prompts/new_video?model=veo-2.0-generate-001"
            );
            await new Promise((resolve) => setTimeout(resolve, 2500));
          ...
          await webviewRef.current.executeJavaScript(`
            ...
            aspectButtons.forEach(btn => {
              ...
              if (text && text.trim() === '${aspectRatio2}') {
                btn.click();
              }
            });
          `);
          ...
          while (attempts < 120) {
            ...
            if (pageContent.includes("Failed to generate video, quota exceeded")) {
              setLogs((prev) => [
                ...prev,
      ...
      while (promptIndex < promptList.length && accountIndex < allAccounts.length) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(HashRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-screen bg-gradient-to-br from-[#1B1B2F] via-[#162447] to-[#1F4068] text-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-white", children: "GridVid" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-white/70 mb-3", children: "Mode" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  onClick: () => setMode("text-to-video"),
                  className: `flex items-center px-4 py-2 rounded-lg transition-all duration-200 ${mode === "text-to-video" ? "bg-purple-600 text-white" : "bg-white/10 text-white/70 hover:bg-white/20"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Type, { className: "w-4 h-4 mr-2" }),
                    "Text"
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex items-center px-4 py-2 rounded-lg transition-all duration-200 ${mode === "image-to-video" ? "bg-purple-600 text-white" : "bg-white/10 text-white/70 hover:bg-white/20"}`,
                  children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: mode === "text-to-video" ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white/70 mb-2", children: "Prompts Input" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: "Load from .txt File"
              }
            )
          ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white/70 mb-2", children: "Images" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white/70 mb-2", children: "General Prompt" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
                  value: prompts,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white/70 mb-2", children: "Save Path" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white/70 mb-2", children: "Aspect Ratio" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  value: aspectRatio2,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-white/70 mb-2", children: "Duration" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "select",
                {
                  value: duration,
                  ...
                  className: "w-full p-3 bg-white/5 rounded-lg border border-white/10 text-white focus:outline-none focus:ring-2 focus:ring-purple-500",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "5", children: "5 seconds" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "6", children: "6 seconds" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "7", children: "7 seconds" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "8", children: "8 seconds" })
                  ]
                }
              )
            ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `w-full px-4 py-3 rounded-lg font-semibold transition-colors duration-200 ${isGenerating ? "bg-gray-600 cursor-not-allowed" : "bg-green-600 hover:bg-green-700"}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                disabled: !isGenerating,
                className: `w-full px-4 py-3 rounded-lg font-semibold transition-colors duration-200 ${!isGenerating ? "bg-gray-600 cursor-not-allowed" : "bg-red-600 hover:bg-red-700"}`,
                children: "Stop Generate"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-grow" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col", children: currentView === "main" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 bg-white/5 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex space-x-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-blue-400", children: stats.total }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white/70", children: "Total Prompts/Images" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-green-400", children: stats.success }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white/70", children: "Success" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-red-400", children: stats.failed }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-white/70", children: "Failed" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col p-4 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 mb-4 relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            initial: { opacity: 0, y: 10 },
        ...
        isPopupDetected && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 right-4 bg-yellow-500 text-white px-4 py-2 rounded-lg shadow-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-pulse mr-2", children: "🔍" }),
          "Mencari popup..."
        ] }) })
      ] }) })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { onBack: () => setCurrentView("main") }) })
  ] }) });
}
